...
Frames are self-calibrating by way of looking up stars in the Gaia DR2 catalog, and matching against our found stars. An SNRdB weighted mean gives the magnitude offset to be used for the image, and the accuracy to be expected. Just mouse around and see the estimated measured magnitudes.
